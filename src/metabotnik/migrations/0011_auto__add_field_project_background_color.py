...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.background_color'
        db.add_column(u'metabotnik_project', 'background_color',
                      self.gf('django.db.models.fields.CharField')(default='#ffffff', max_length=7),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.background_color'
        db.delete_column(u'metabotnik_project', 'background_color')
