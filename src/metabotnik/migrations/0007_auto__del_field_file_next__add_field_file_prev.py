...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'File.next'
        db.delete_column(u'metabotnik_file', 'next_id')

        # Adding field 'File.prev'
        db.add_column(u'metabotnik_file', 'prev',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['metabotnik.File'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'File.next'
        db.add_column(u'metabotnik_file', 'next',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['metabotnik.File'], unique=True, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'File.prev'
        db.delete_column(u'metabotnik_file', 'prev_id')
    ...
    models = {
        ...
        u'metabotnik.file': {
            ...
            'prev': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['metabotnik.File']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
