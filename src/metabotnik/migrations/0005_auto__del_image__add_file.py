...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'metabotnik_image')

        # Adding model 'File'
        db.create_table(u'metabotnik_file', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='blobs', to=orm['metabotnik.Project'])),
        ...
        db.send_create_signal(u'metabotnik', ['File'])


    def backwards(self, orm):
        # Adding model 'Image'
        db.create_table(u'metabotnik_image', (
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='images', to=orm['metabotnik.Project'])),
            ('width', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('metadata', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('size', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('height', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ...
        db.send_create_signal(u'metabotnik', ['Image'])

        # Deleting model 'File'
        db.delete_table(u'metabotnik_file')
    ...
    models = {
        ...
        u'metabotnik.file': {
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'blobs'", 'to': u"orm['metabotnik.Project']"}),
