...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'File.x'
        db.add_column(u'metabotnik_file', 'x',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'File.y'
        db.add_column(u'metabotnik_file', 'y',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'File.x'
        db.delete_column(u'metabotnik_file', 'x')

        # Deleting field 'File.y'
        db.delete_column(u'metabotnik_file', 'y')
