...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.preview_height'
        db.delete_column(u'metabotnik_project', 'preview_height')

        # Deleting field 'Project.metabotnik_width'
        db.delete_column(u'metabotnik_project', 'metabotnik_width')

        # Deleting field 'Project.metabotnik_height'
        db.delete_column(u'metabotnik_project', 'metabotnik_height')

        # Deleting field 'Project.preview_width'
        db.delete_column(u'metabotnik_project', 'preview_width')

        # Adding field 'Project.layout_data'
        db.add_column(u'metabotnik_project', 'layout_data',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Project.preview_height'
        db.add_column(u'metabotnik_project', 'preview_height',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Project.metabotnik_width'
        db.add_column(u'metabotnik_project', 'metabotnik_width',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Project.metabotnik_height'
        db.add_column(u'metabotnik_project', 'metabotnik_height',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Project.preview_width'
        db.add_column(u'metabotnik_project', 'preview_width',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Project.layout_data'
        db.delete_column(u'metabotnik_project', 'layout_data')
    ...
    models = {
        ...
        u'metabotnik.project': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'layout_data': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'metabotnik.task': {
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'tasks'", 'null': 'True', 'to': u"orm['metabotnik.Project']"}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'new'", 'max_length': '100'}),
