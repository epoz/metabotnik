...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.storage_size'
        db.add_column(u'metabotnik_project', 'storage_size',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.storage_size'
        db.delete_column(u'metabotnik_project', 'storage_size')
