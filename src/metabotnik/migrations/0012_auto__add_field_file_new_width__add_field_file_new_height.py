...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'File.new_width'
        db.add_column(u'metabotnik_file', 'new_width',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'File.new_height'
        db.add_column(u'metabotnik_file', 'new_height',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'File.new_width'
        db.delete_column(u'metabotnik_file', 'new_width')

        # Deleting field 'File.new_height'
        db.delete_column(u'metabotnik_file', 'new_height')
