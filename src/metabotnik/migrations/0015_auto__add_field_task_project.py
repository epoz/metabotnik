...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'metabotnik_task', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='tasks', null=True, to=orm['metabotnik.Project']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.project'
        db.delete_column(u'metabotnik_task', 'project_id')
